...
import {ImageTextRow, Row, RowElement, Table} from "entities/text-block/model/types";
...
import {Page} from "../../pages/UniversalPage/model/types";
...
export const links = {
    ...
    linksB: [
        ...
        {title: "Наука", to: RouterNames.SCIENCE},
        {
            title: "Факультети", to: "/",
            subLinks: [
                {id: 1, title: "Факультет телекомунікаційних систем", to: RouterNames.FACULTY_1},
                {id: 8, title: "Факультет інформаційних технологій", to: RouterNames.FACULTY_2},
                {
                    id: 9,
                    title: "Факультет бойового застосування систем управління та звʼязку",
                    to: RouterNames.FACULTY_3
                },
            ]
        },
        {
...
export const sciences: AccordionElement[] = [
    {
