        ...
        textBlocks: [
            ...
            } as TextBlock,
            {
                ...
                tables: [
                    {
                        headers: [
                            "<strong>Якщо Ви здобувач вищої освіти</strong>",
                            "<strong>Якщо у Вас вже є вища освіта</strong>"
                        ],
                        rows: [
                            {
                                elements: [
                                    {value: ["Подати до приймальної комісії заяву підписану \n" +
                                        ...
                                        "про бажання проходити військову підготовку"]} as RowElement,
                                    {value: ["Подати до приймальної комісії заяву на ім’я голови \n" +
                                        "відбіркової комісії, про бажання проходити військову підготовку"]} as RowElement,
                                ]
                            } as Row,
                            {
                                elements: [
                            ...
                            } as Row,
                            {
                                elements: [
                                    {value: ["копію довідки про присвоєння реєстраційного номера \n" +
                                        "облікової картки платника податків"]} as RowElement,
                                    {value: ["копію довідки про присвоєння реєстраційного номера \n" +
                                        "облікової картки платника податків"]} as RowElement,
                                ]
                            } as Row,
                            {
                                elements: [
                                    {value: ["копію посвідчення про приписку до призовної дільниці \n" +
                                        "(для осіб чоловічої статі)"]} as RowElement,
                                    {value: [""]} as RowElement,
                                ]
                            } as Row,
                            {
